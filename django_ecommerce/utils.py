...
def unique_slug_generator(instance, new_slug=None):
    ...
    qs_exists = Klass.objects.filter(slug=slug).exists() #jak istnieje juz ze slugiem takim jak tytul to dodaje tego rand stringa w nieskonczonosc az bedzie unique
    if qs_exists:
